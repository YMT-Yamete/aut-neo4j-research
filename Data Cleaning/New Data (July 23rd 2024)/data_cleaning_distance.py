...
route_stop_df.to_csv('route_stop_mapping_with_distance.csv', index=False)

print("Route stop mapping with distance to the next stop has been saved successfully!")
